        ...
        <div data-toggle="collapse" data-target="#message1">
          <div class="media">
            ...
            <div class="media-body">
              ...
              <div class="b-t">
               <small>Author: {{ tweet.user.name }}</small> |
               <small>App: {{ tweet.app_name }}</small> |
               <small>Country: {{ tweet.user.name }}</small>
              </div>
            </div>
          </div>
        </div>
            ...
            <ul class="list-unstyled">
              ...
              <div class="avatar avatar-md blue mr-3">
                ...
                <div class="media-body text-truncate">
                  ...
                  {{reply.user.name}}
                </h6><span>{{reply.full_text}}</span><br>
                <small>
                  <span class="mr-3" v-if="reply.user.location">Location: {{reply.user.location}}</span>
                  </small>
                  </div></li>
