  ...
  <div>
    <!--#navbar-->
                    ...
                    <div class="col">
                        <div class="pb-3">
                            <div class="image mr-3  float-left">
                             <!-- class="user_avatar no-b no-p" -->
                     
                       <user-avatar
                      
                     :name="user.name" 
                     :image="user.image"
                      imageClass="user_avatar"
                    />
                            </div>
                            <div>
       ...
       <div class="container-fluid animatedParent animateOnce my-3">
                           ...
                           <div class="card ">
                               <ul class="list-group list-group-flush">
                                   <li class="list-group-item">
                                     <i class="icon icon-mobile text-primary"></i>
                                     <strong class="s-12">Phone</strong> <span class="float-right s-12">{{user.phone}}</span>
                                    </li>
                                   ...
                                   <li class="list-group-item"><i class="icon icon-address-card-o text-warning"></i><strong class="s-12">Address</strong> <span class="float-right s-12">{{user.address}}</span></li>
                                   <li class="list-group-item"><i class="icon icon-web text-danger"></i> <strong class="s-12">Website</strong> <span class="float-right s-12">{{user.website}}</span></li>
                               </ul>
                           </div>
         ...
         xxxx
            <div class="animatedx fadeInUpShortx">
           <div >
               <div>
...
export default {
 ...
 mixins: [mixins],
  ...
  created(){
    this.user = jsonData[this.$route.params.id];
